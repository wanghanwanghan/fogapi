...
return [
    ...
    //===================================================================================================
    //端门坐标
    'm0'=>['lat'=>'39.9104000000','lng'=>'116.3973920000'],
    //===================================================================================================
    //RequestToken的过期时间 防止用户暴力请求 单位秒
    'RequestTokenExpireTime'=>5,
    //===================================================================================================
    //每个格子每天最大交易次数
    'GridTodayBuyTotle'=>9,
    //===================================================================================================
    ...
    'InitBuyCard'=>10,
    //===================================================================================================
    //交易保护5分钟300秒，成交的格子距离下次可以被购买需要5分钟等待
    'TradeGuard'=>300,
    //===================================================================================================
    //格子交易税,百分数
    'BuyUser' =>0,
    ...
    //===================================================================================================
    //钱袋每天领取上限
    'UserWalletLimit'=>1000,
    //钱袋每次领取上限
    'WalletLimit'=>200,
    //===================================================================================================
    //每天限制多少人传迷雾，必须是100，1000，10000....
    'PeopleLimt'=>1000,
    //当迷雾队列总数超过这个值时，必须是1千万，2千万，3千万....
    'FogLimit'=>10000000,
    //===================================================================================================
    //每天限制多少人传足迹
    'ZuJiPeopleLimt'=>1000,
