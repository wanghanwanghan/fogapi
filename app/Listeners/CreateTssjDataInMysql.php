...
class CreateTssjDataInMysql
{
     ...
     * Handle the event.
     *
     * @param  CreateTssjOrderEvent  $event
     * @return void
     */
    public function handle(CreateTssjOrderEvent $event)
    {
        ...
        DB::connection('userOrder')->table('tssj'.$year)->insert($insert);
    }
}
